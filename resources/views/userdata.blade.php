    ...
    <div class="sidebar" id="sidebar">
        <div class="px-3">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/userdata">Anggota</a>
                </li>
                <li class="nav-item">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{ route('registers') }}" method="POST" class="row g-3 needs-validation"
                                novalidate>
                                @csrf
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="jabatan" class="form-control" id="yourjabatan"
                                        required>
