                                    ...
                                    <form method="post"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <img src="{{ $admin->foto }}" alt="Profile">
                                                <div class="pt-2">
                                                ...
                                                <select name="departemen" id="departemen" class="form-select">
                                                    @foreach ($organisasi as $org)
                                                        <option value="{{ $org->id_organisasi }}"
                                                            {{ $admin->departemen == $org->nama ? 'selected' : '' }}>
                                                            {{ $org->nama }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="jabatan" type="text" class="form-control"
                                                    id="jabatan" value="{{ $admin->jabatan }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label for="more"
                                                class="col-md-4 col-lg-3 col-form-label">More</label>
                                            <div class="col-md-8 col-lg-9">
                                                <textarea name="more" class="form-control" id="more">{{ $admin->more }}</textarea>
                                            </div>
                                        </div>
